...
function openLetter(letter) {
  ...
  /* Клетка за приход: сервер отдаст её только первый раз за сутки. */
  reportVisit(letter);
  unmountCurrent = () => {
    unmountCredit();
    unmountHint();
