/* И — волна и её зубцы.
   ...
   Отсчёт начинается с t₀ = π: там перо стоит на строке, и волна выходит из
   базовой линии, а не из середины воздуха. Зубцы считаются по вершинам,
   их ровно столько, сколько периодов.
...
/* Высота зуба долей роста: 0 на строке, 1 на вершине. */
...
function wavePath(p) {
  ...
  /* Перо не идёт по строке ровно: внизу оно медлит и чаша выходит широкой,
     на вершине торопится и сводит её углом. Сверх единицы оно успевает уйти
     назад — на вершине набухает петля. */
